...
public:
  ...
  MOCK_METHOD(int, getBytesAvailable, (), (const override));
  MOCK_METHOD(int, readPort, (char *, const int), (const override));
  MOCK_METHOD(int, writePort, (const char *, const int), (const override));
};
